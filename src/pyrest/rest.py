            ...
            if method in ['POST', 'PUT', 'PATCH', 'OPTIONS', 'DELETE']:
                ...
                if re.search('json', headers['Content-Type'], re.IGNORECASE):
                    ...
                    r = self.pool_manager.request(
                        ...
                        timeout=timeout,
                        headers=headers)
                elif  (headers['Content-Type'] == 'application/zip' or headers['Content-Type'][:6] == 'image/'):
                    if body is not None:
                        # must del headers['Content-Type'], or the correct
                        # Content-Type which generated by urllib3 will be
                        # overwritten.
                        ...
                        r = self.pool_manager.request(
                            ...
                            timeout=timeout,
                            headers=headers)
                    else: # means we have post params
...
class ApiClient(object):
    ...
    def __test_setup(self, resource_path, method, path_params=None,
